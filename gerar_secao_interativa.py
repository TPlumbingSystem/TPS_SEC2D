...
MESTRADO = Path(__file__).parent.parent.parent
BASE = MESTRADO / "1_Modelo_3D_Taio"
TOPO_NPY = BASE / "dados_entrada" / "topografia_drone" / "topografia_xyz.npy"
POLIGONO_REFERENCIA = MESTRADO / "2_Banco_de_Dados" / "dados_base" / "poligon_intrusiva.shp"
POLIGONOS_CPRM_GEOJSON = MESTRADO / "2_Banco_de_Dados" / "saida_processada" / "formacoes_cprm_poligonos.geojson"
OSM_RIOS_GEOJSON = MESTRADO / "2_Banco_de_Dados" / "saida_processada" / "osm_rios.geojson"
OSM_ESTRADAS_GEOJSON = MESTRADO / "2_Banco_de_Dados" / "saida_processada" / "osm_estradas.geojson"
OSM_LUGARES_GEOJSON = MESTRADO / "2_Banco_de_Dados" / "saida_processada" / "osm_lugares.geojson"
PONTOS_CAMPO_GPKG = (
    MESTRADO / "2_Banco_de_Dados" / "Unificação" / "GPKG_Novos" / "pontos_unificados_completo.gpkg"
)
PONTOS_ESTRUTURAIS_GPKG = (
    MESTRADO / "2_Banco_de_Dados" / "Unificação" / "GPKG_Novos" / "nuvem_pontos_direcoes.gpkg"
)
LOGO_PATH = Path(__file__).parent / "assets" / "logo_taio.png"
...
MARCA_ROXO_ESCURO = "#1B263B"  # nova identidade TAIO -- fundo secundario (era roxo escuro)
MARCA_ROXO = "#E23D2B"  # nova identidade TAIO -- cor de destaque (era roxo)
MARCA_AZUL = "#547B8C"  # nova identidade TAIO
MARCA_NAVY = "#0D1B2A"  # nova identidade TAIO -- fundo principal
MARCA_CINZA_CLARO = "#F2F4F5"  # nova identidade TAIO
